...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/GameLogin': RouteRecordInfo<'/GameLogin', '/GameLogin', Record<never, never>, Record<never, never>>,
    ...
    '/NightmareBattle': RouteRecordInfo<'/NightmareBattle', '/NightmareBattle', Record<never, never>, Record<never, never>>,
    '/NotFound': RouteRecordInfo<'/NotFound', '/NotFound', Record<never, never>, Record<never, never>>,
    '/Profile': RouteRecordInfo<'/Profile', '/Profile', Record<never, never>, Record<never, never>>,
    '/Register': RouteRecordInfo<'/Register', '/Register', Record<never, never>, Record<never, never>>,
    '/SaltField': RouteRecordInfo<'/SaltField', '/SaltField', Record<never, never>, Record<never, never>>,
