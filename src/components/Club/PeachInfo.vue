  ...
  <div ref="exportDom" class="peach-info-card">
    <div class="toolbar">
      ...
      <div class="right">
        ...
        <NButton class="refresh-btn" size="small" :disabled="loading" @click="fetchBattleRecordsByDate">
          <template #icon>
            <NIcon>
              <Refresh></Refresh>
            </NIcon>
    ...
    <div v-if="battleInfo" class="header-section">
      <div class="club-vs-container">
        ...
        <div class="club-info own">
          <NAvatar round class="club-logo" :size="80" :src="battleInfo.ownClub?.logo || '/icons/xiaoyugan.png'"></NAvatar>
          <div class="club-details">
            ...
            <div class="club-stats">
              {{ battleInfo.ownClub.memberCount }}人 | {{ battleInfo.ownClub.quenchNum }}红 | {{
        ...
        <div class="club-info opponent">
          <NAvatar round class="club-logo" :size="80" :src="battleInfo.opponentClub?.logo || '/icons/xiaoyugan.png'"></NAvatar>
          <div class="club-details">
            <div class="club-name">
    ...
    <div v-else-if="opponentMembers.length > 0" class="members-table">
      ...
      <NDataTable flex-height striped size="small" :bordered="false" :columns="columns" :data="opponentMembers"></NDataTable>
    </div>
      ...
      <div v-if="playerInfo" class="player-info-content">
        ...
        <div class="action-section">
          <div style="display: flex; align-items: center; gap: 8px; flex: 1">
            ...
            <NButton size="small" style="margin-right: 8px" type="tertiary" @click="showPlayerInfoModal = false">
              关闭
            </NButton>
          </div>
    ...
    >
      <div v-if="heroModealTemp" class="hero-modal-content">
        <div class="hero-modal-header">
          <NAvatar round class="hero-modal-avatar" :size="80" :src="heroModealTemp.heroAvate"></NAvatar>
