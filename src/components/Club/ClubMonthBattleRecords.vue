    ...
    <div class="club-month-battle-records-card">
      ...
      <div class="header-section">
        ...
        <div class="header-actions">
          ...
          <n-button size="small" type="primary" :disabled="!monthlyBattleRecords || loading" @click="handleExport">
            <template #icon>
              <n-icon>
                <Copy></Copy>
              </n-icon>
      ...
      <div class="battle-records-content">
        ...
        <!-- 本月战绩列表 -->
        <div ref="exportDom" v-else-if="monthlyBattleRecords && Object.keys(monthlyBattleRecords).length > 0" class="records-list">
          <!-- Default Style -->
          ...
          <div v-else-if="currentStyle === 'style2'" class="style-2">
            ...
            <div class="style2-dashboard">
              ...
              <div v-if="monthlyMvpPlayer" class="dashboard-mvp">
                <img v-if="monthlyMvpPlayer.headImg" class="mvp-avatar" :src="monthlyMvpPlayer.headImg" @error="handleImageError">
...
const avgKills = computed(() => {
  if (!sortedMembers.value || sortedMembers.value.length === 0)
    return 0;
...
const getKillColor = (val) => {
  if (val >= 200)
    return "rgba(76, 175, 80, 0.3)"; // Adjusted threshold for monthly
  if (val >= 80)
