<template>
  <div class="records-container">
    ...
    <div class="header-section">
      ...
      <!-- 数据统计区 -->
      <div v-if="battleRecords && battleRecords.roleDetailsList" class="stats-section">
        <div class="stat-item">
    ...
    <div class="battle-records-content">
      ...
      <div v-else-if="battleRecords && battleRecords.roleDetailsList" class="records-wrapper">
        <!-- 样式一 -->
        <div ref="exportDom" v-if="currentStyle === 'style1'" class="records-list style-1">
          <!-- 头部信息 -->
                  ...
                  <tr v-for="(player, index) in battleRecords.roleDetailsList" :key="player.roleId">
                    ...
                    <td class="col-name">
                      <div class="player-info">
                        <img v-if="player.headImg" class="player-avatar-small" :src="player.headImg" @error="handleImageError">
            ...
            <div class="style1-summary">
              ...
              <div class="summary-card purple-header">
                ...
                <div v-for="(player, index) in killRank" :key="`kill-${index}`" class="top3-item">
                  ...
                  <div class="top3-info">
                    <img v-if="player.headImg" class="player-avatar-xs" :src="player.headImg" @error="handleImageError">
        ...
        <!-- 样式二 -->
        <div ref="exportDom" v-else-if="currentStyle === 'style2'" class="records-list style-2">
          ...
          <div class="style2-dashboard">
            ...
            <div v-if="mvpPlayer" class="dashboard-mvp">
              <img v-if="mvpPlayer.headImg" class="mvp-avatar" :src="mvpPlayer.headImg" @error="handleImageError">
              ...
              <div class="rank-list-s2">
                <div v-for="(player, index) in killRank" :key="`s2-kill-${index}`" class="rank-item-s2">
                  ...
                  <div class="rank-player-s2">
                    <img v-if="player.headImg" class="avatar-xxs" :src="player.headImg">
                ...
                <tr v-for="(player, index) in battleRecords.roleDetailsList" :key="`s2-row-${player.roleId}`">
                  ...
                  <td>
                    <div class="player-cell">
                      <img v-if="player.headImg" class="avatar-xs" :src="player.headImg">
...
const totalKills = computed(() => {
  if (!battleRecords.value?.roleDetailsList)
    return 0;
...
const avgKills = computed(() => {
  if (!battleRecords.value?.roleDetailsList || battleRecords.value.roleDetailsList.length === 0)
    return 0;
...
const getOccupyColor = (val) => {
  if (val >= 100)
    return "rgba(255, 204, 128, 0.3)";
  if (val >= 50)
    return "rgba(255, 224, 178, 0.3)";
  return "transparent";
};

const getDeathColor = (val) => {
  if (val >= 20)
    return "rgba(239, 154, 154, 0.3)";
  if (val >= 10)
    return "rgba(255, 205, 210, 0.3)";
  return "transparent";
};

const getReviveColor = (val) => {
  if (val >= 5)
    return "rgba(200, 230, 201, 0.3)";
  return "transparent";
};
...
const exportToImage = async () => {
  ...
  try {
    ...
    const originalWidth = exportDom.value.style.width;
    const originalMaxWidth = exportDom.value.style.maxWidth;
    ...
    if (isMobile) {
      ...
      // PC端：自动宽度
      exportDom.value.style.width = "auto";
