<template>
  <div class="records-container">
    ...
    <div class="battle-records-content">
      ...
      <!-- 战绩列表 -->
      <div ref="exportDom" v-else-if="battleRecords && battleRecords.ownClub && battleRecords.opponentClub" class="records-wrapper">
          ...
          <div class="battle-header">
            ...
            <div class="club-info">
              <div class="club-side own">
                <img v-if="battleRecords.ownClub.logo" class="club-logo" :alt="battleRecords.ownClub.name" :src="battleRecords.ownClub.logo">
              ...
              <div class="club-side opponent">
                <img v-if="battleRecords.opponentClub.logo" class="club-logo" :alt="battleRecords.opponentClub.name" :src="battleRecords.opponentClub.logo">
              ...
              <div class="ranking-content">
                <div class="ranking-side own">
                  ...
                  <div v-for="(player, index) in battleRecords.ownClub.killRank.slice(0, 3)" :key="index" class="ranking-item">
                    ...
                    <img v-if="player.roleInfo.headImg" class="player-avatar" :alt="player.roleInfo.name" :src="player.roleInfo.headImg" @error="handleImageError">
                      ...
                      <tr v-for="(player, index) in battleRecords.ownClub.killRank" :key="index">
                        ...
                        <td class="col-name">
                          <div class="player-info">
                            <img v-if="player.roleInfo.headImg" class="player-avatar-small" :src="player.roleInfo.headImg" @error="handleImageError">
                    ...
                    <tr v-for="(player, index) in battleRecords.ownClub.killRank" :key="index">
                      ...
                      <td>
                        <div class="player-cell">
                          <img v-if="player.roleInfo.headImg" class="avatar-xs" :src="player.roleInfo.headImg">
