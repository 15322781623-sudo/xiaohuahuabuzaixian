  ...
  <div>
    ...
    <div v-if="inline" class="inline-wrapper">
      ...
      <div class="weird-tower-content">
        ...
        <!-- 爬塔列表 - 表格展示 -->
        <div ref="exportDom" v-else-if="memberScores.length > 0" class="records-list" style="overflow-x: auto; max-width: 100%;">
          <NDataTable
            striped
            size="small"
            :bordered="false"
    ...
    >
      <template #header-extra>
        <div class="header-actions">
          ...
          <NButton size="small" type="primary" :disabled="!memberScores || loading" :loading="isExporting" @click="handleExport">
            <template #icon>
              <NIcon>
                <Copy></Copy>
              </NIcon>
                  ...
                  [
                    ...
                    h(
                      NButton,
                      {
                        ...
                        secondary: true,
                        onClick: (e) => {
                          e.stopPropagation(); handleExport();
                        },
