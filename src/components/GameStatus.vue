  ...
  >
    ...
    <div v-if="activeSection === 'saltFieldGroup'" class="salt-field-group">
      <div class="sub-nav">
        ...
        >
          ...
          <n-tab-pane name="weekBattle" tab="本周盐场战绩"></n-tab-pane>
          <n-tab-pane name="monthBattle" tab="本月盐场战绩"></n-tab-pane>
          <n-tab-pane name="legionWarMap" tab="盐场地图"></n-tab-pane>
          <n-tab-pane name="legionWarStatistics" tab="盐场战况"></n-tab-pane>
        </n-tabs>
      </div>
    ...
    <div v-if="activeSection === 'peachGroup'" class="peach-group">
      <div class="sub-nav">
        ...
        >
          <n-tab-pane name="peach" tab="蟠桃园信息"></n-tab-pane>
          <n-tab-pane name="peachBattle" tab="蟠桃园战绩"></n-tab-pane>
        </n-tabs>
      </div>
    ...
    <div v-if="activeSection === 'rankGroup'" class="rank-group">
      <div class="sub-nav">
        <n-tabs animated size="small" type="segment" v-model:value="rankSubTab">
          <n-tab-pane name="serverrank" tab="区服榜"></n-tab-pane>
          ...
          <n-tab-pane name="greatRouteRank" tab="伟大航路积分榜"></n-tab-pane>
        </n-tabs>
      </div>
