...
export class XyzwLegionWarWebSocketClient {
  ...
  _handlePromiseResponse(packet) {
    ...
    const responseToCommandMap = {
      ...
      syncrewardresp: ["system_buygold", "discount_claimreward", "card_claimreward", "artifact_lottery", "genie_sweep", "genie_buysweep", "system_signinreward", "dungeon_selecthero"],
    };
