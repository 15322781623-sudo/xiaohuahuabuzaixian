...
export const availableTasks = [
  ...
  { label: "盐场创地", value: "batchSaltFieldDig" },
  ...
  { label: "新区一键换皮闯关", value: "newSkinChallenge" },
  { label: "新区一键换皮寻宝", value: "newSkinTreasure" },
