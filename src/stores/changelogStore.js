...
export const useChangelogStore = defineStore("changelog", () => {
  ...
  },
  {
    ...
    date: "2026-07-09",
    type: "minor",
    title: "批量推图优化 & 消耗活动模块 & UI交互优化",
    features: [
      "新增消耗活动模块：将消耗活动、领取消耗活动道具、挥鼓助威消耗、使用消耗活动道具、消耗活动兑换购买统一归入独立标签页",
    ],
    improvements: [
      "批量推图战斗结果解析简化：采用顶层字段直接判定胜负，逻辑更清晰",
      "批量推图200020服务器错误优化：重试次数3次提升至5次，等待时间从3秒延长至8秒，给服务器更多结算时间",
      "展开/收起按钮合并为单按钮切换：闯关、爬塔、Boss塔、进化塔模块的展开收起统一为一个按钮，与隐藏卡片交互一致",
      "按钮UI优化：切换按钮采用 quaternary 类型，视觉更简洁",
    ],
    fixes: [
      "修复日常任务延迟未使用设置面板模块延迟配置的问题，DailyTaskRunner 现在正确接收 batchSettings 参数",
      "修复批量推图获取战斗结果时200020服务器错误导致频繁失败的问题",
    ],
    removals: [
  ...
  },
  {
    ...
    features: [
      ...
      "场次选择：支持第1场到第7场的场次切换",
      "分组选择：支持第1组到第32组的分组切换，切换时自动刷新俱乐部列表",
      "全部赠送模式：赠送数量设为0时自动获取每个账号的助威币数量进行全部赠送",
